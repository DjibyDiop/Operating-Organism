...
- **Adaptive Organs**: cortex (`OPI-baremetal` / thalamic-bloom), endocrine (`vital-baremetal`), digestive (`sense-baremetal`), mutation (`evolution-baremetal`, `regen-baremetal`).
...
| `OPI-baremetal` | Brain Cortex (thalamic-bloom SSM) | Adaptive |
